...
main(int _ac, char *_av[])
{
  ...
  halt();
   6:	e8 f8 02 00 00       	call   303 <halt>
  return 0;
}
   b:	31 c0                	xor    %eax,%eax
   d:	c9                   	leave  
...
free(void *ap)
{
 ...
 561:	a1 ec 09 00 00       	mov    0x9ec,%eax
{
 ...
 5a1:	5b                   	pop    %ebx
  freep = p;
 5a2:	89 15 ec 09 00 00    	mov    %edx,0x9ec
}
 5a8:	5e                   	pop    %esi
 5a9:	5f                   	pop    %edi
 5aa:	5d                   	pop    %ebp
 ...
 5d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5dc:	89 15 ec 09 00 00    	mov    %edx,0x9ec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 3d ec 09 00 00    	mov    0x9ec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 63f:	73 4f                	jae    690 <malloc+0xa0>
    ...
    if(p == freep)
 641:	8b 3d ec 09 00 00    	mov    0x9ec,%edi
 ...
 66a:	e8 f1 fe ff ff       	call   560 <free>
  return freep;
 66f:	8b 15 ec 09 00 00    	mov    0x9ec,%edx
 ...
 69c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 69f:	89 15 ec 09 00 00    	mov    %edx,0x9ec
}
 ...
 6af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6b0:	c7 05 ec 09 00 00 f0 	movl   $0x9f0,0x9ec
 6b7:	09 00 00 
    base.s.size = 0;
 6ba:	bf f0 09 00 00       	mov    $0x9f0,%edi
    base.s.ptr = freep = prevp = &base;
 6bf:	c7 05 f0 09 00 00 f0 	movl   $0x9f0,0x9f0
 6c6:	09 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6cb:	c7 05 f4 09 00 00 00 	movl   $0x0,0x9f4
 6d2:	00 00 00 
    if(p->s.size >= nunits){
